...
In Daten aus dem Partners Health-Care Research Patient Data Registry (USA) war die ICM-Exposition mit dem Auftreten einer Hyperthyreose (definiert als ein supprimiertes TSH <0,1 mIU/L; **Odds Ratio [OR], 2,50**; 95% CI, 1,065,93) und mit dem Auftreten einer Hypothyreose (definiert als erhöhtes Serum-TSH >10 mIU/L; **OR, 3,05**; 95% CI, 1,078,72) verbunden. @BednarczukEtAl2021
...
Ein dramatischer Rückgang der Expression des Natriumiodid-Symporters führt zu einem verringerten Jodtransport und der anschließenden Wiederaufnahme der Schilddrüsenhormonsynthese. @PramyothinEtAl2011
