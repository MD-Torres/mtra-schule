...
Im 1982 Heald führte der totalen mesorektalen Exzision (TME). 
Bei der TME wird das komplete Mesorektum entfernt, wodurch die Lokalrezidivrate auf 3-7 % gesenkt werden konnte. 
Die OS nach 5 Jahren war 87 %. @HealdRyall1986
...
Die **adjuvante Therapie** war jedoch mit mehreren theoretischen Nachteilen verbunden: Mikrometastasen werden verzögert behandelt, was das Risiko für Fernmetastasen erhöht. Das Ansprechen des Tumors ist oft geringer, da die Durchblutung im postoperativen Gewebe eingeschränkt ist.
...
Die Total neoadjuvante Therapie (TNT) verbessert die Ansprechraten. Bei einigen Patient:innen mit klinisch oder pathologisch komplettem Ansprechen (cCR) kann eine Operation sogar vermieden werden – wie etwa in der OPRA-Studie gezeigt wurde [@Garcia-AguilarEtAl2022]. 
