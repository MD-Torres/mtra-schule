...
Wenn eine genetische Beratung nach dem Vorliegen des Testergebnisses gewünscht wird, darf die Beratung nur durch einen Facharzt für Humangenetik oder einen nach dem GenDG qualifizierten Arzt vorgenommen werden. @DGHO2020; @zotero-4625
...
=======
Bei T1-High-Risk-Karzinomen (G3/4 u./o. Lymphgefäßinvasion) und bei T2 Karzinomen liegt das Auftreten von Lymphknotenmetastasen bei 10–20%, sodass die alleinige lokale Exzision nicht empfohlen werden kann, und eine primäre radikale Operation oder eine sekundäre radikale Nachoperation indiziert sind. 
>>>>>>> 380e1ec5214a3c78865695e9b925c04643f23d3d
...
##### Rektumerhalt intendiert ***und*** sinnvoll 
Bei Vorliegen einer kompletten klinischen Remission (cCR) nach Strahlenchemotherapie bzw. TNT, kann auf eine Operation verzichtet werden. 
Eine ausführliche Aufklärung des Pat. und eine Bereitschaft zu einer engmaschigen, mindestens 5-jährigen Nachsorge ist zu fordern. @Ralf-DieterHofheinzEtAl2025
...
<<<<<<< HEAD
Rektumkarzinome im oberen Drittel ohne Risikokonstellation für ein Lokal-rezidiv sollen primär operiert. Jedoch eine präoperative Radio-/ Radiochemotherapie ***kann***, Bei einer Risikokonstellation, erfolgen @DeutscheKrebsgesellschaftEtAl2019 z.B.:
=======
...
Für Patienten bei denen ein Downsizing angestrebt ist, kann auch die Kurzzeitbestrahlung mit längerem Intervall bis zu 12 Wochen zur Operation (mit und ohne neoadjuvante Chemotherapie) durchgeführt werden. @@DeutscheKrebsgesellschaftEtAl2019
