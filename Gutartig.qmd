...
Gelenkbeschwerden und -schmerzen gehören weltweit zu den häufigsten Einschränkungen, die Menschen bei der Ausübung ihrer Alltagsaktivitäten Schwierigkeiten bereiten und ihre Lebensqualität verringern können. [@RKI2017] 
...
ggplot(data, aes(x = Altersgruppe, y = Praevalenz, group = Geschlecht, color = Geschlecht)) +
  ...
  labs(title = "<p>Die Prävalenz von Gelenkschmerzen steigt in <span style='color:#f5d438'>Frauen</span> <br>und <span style='color:#9dccda'>Männer</span> mit zunehmendem Alter</p>",
       x = "Altersgruppe in Jahre",
