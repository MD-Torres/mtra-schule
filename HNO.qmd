...
data %>%
  ...
  geom_bar(
    stat = "identity",
    show.legend = FALSE,
    width = 0.6  # Make bars slimmer by reducing the width
  ) +  
  scale_fill_identity() +  
  ...
  theme(
    plot.title = element_markdown(hjust = 0.5, family = "Ubuntu", size = 26, face = "bold", color = "#FFFFFF"),  # Title in white
    plot.subtitle = element_markdown(hjust = 0.5, family = "Ubuntu", size = 22, face = "bold", color = "#D3D3D3"),  # Subtitle in light grey
    plot.caption = element_markdown(hjust = 0.5, size = 10, color = "#D3D3D3"),
    ...
    axis.text.x = element_text(
      ...
      family = "Ubuntu", 
      face = "bold", 
      color = "#D3D3D3",  # Light gray for axis labels
      size = 12
    ),
    axis.title.x = element_blank(),
    axis.title.y = element_blank(),
    ...
    axis.ticks.y = element_line(color = "#7f7f7f", size = 1.5),
    axis.ticks.length.y = unit(6, "pt"),
    axis.line.y = element_line(color = "#7f7f7f", size = 1.2),
    
    plot.title.position = "plot",  # Title position relative to the plot area
    plot.margin = margin(t = 20)  # Adjust the top margin if needed
  )
