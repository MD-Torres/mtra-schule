...
#| layout-ncol: 2
#| fig-cap: 
#| - "Inzidenz in Deutschland im Zeitraum 1999–2022 basierend auf Daten des Zentrums für Krebsregisterdaten des Robert Koch-Instituts (RKI).[@ZentrumfurKrebsregisterdatenimRobertKoch-Institut2024] "
#| - "Inzidenz in Deutschland im Zeitraum 1999–2022 basierend auf Daten des Zentrums für Krebsregisterdaten des Robert Koch-Instituts (RKI).[@ZentrumfurKrebsregisterdatenimRobertKoch-Institut2024] "
...
data %>% 
  ...
  theme_minimal() +  
  labs(
    title = "<p><span style='color:#7f7f7f'>Häufigste Neubildungen bei Frauen:<br> Mundhöhle und Lippe</span></p>",
  ) +
  theme(
...
data %>% 
  ...
  theme_minimal() +  
  labs(
    title = "<p><span style='color:#7f7f7f'>Oropharynx-Tumoren:<br> Die häufigste Diagnose bei Männern</span></p>",
  ) +
  theme(
    plot.title = element_markdown(hjust = 0.5, family = "Ubuntu", size = 20, face = "bold"),
    plot.caption = element_markdown(hjust = 0.5, size = 10),
