...
color_palette <- c("#0d7d87","#ff5a5e",  "#99c6cc", "#c31e23" )
...
data %>% 
  ...
  theme_minimal() +  
  labs(
    title = "<p><span style='color:#7f7f7f'>Verteilung der Krebserkrankungen<br> im Rachenbereich bei Frauen</span></p>",
  ) +
  theme(
    plot.title = element_markdown(hjust = 0.5, family = "Ubuntu", size = 20, face = "bold"),
    plot.caption = element_markdown(hjust = 0.5, size = 10),
    ...
    axis.title.y = element_blank(),  # Remove y axis title
    #axis.text.y = element_blank(),  # Remove y axis text
    axis.text.y = element_text(family = "Ubuntu", face = "bold", color = "#595959", size = 8),  
    axis.ticks = element_blank()  # Remove axis ticks
  )
...
data %>% 
  ...
  theme_minimal() +  
  labs(
    title = "<p><span style='color:#7f7f7f'>Verteilung der Krebserkrankungen<br> im Rachenbereich bei Männer</span></p>",
  ) +
  theme(
    plot.title = element_markdown(hjust = 0.5, family = "Ubuntu", size = 20, face = "bold"),
    plot.caption = element_markdown(hjust = 0.5, size = 10),
